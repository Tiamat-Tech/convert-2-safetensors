...
- In the coming weeks, I plan to update this repo to allow users to choose between fp16, fp32, bf16 & tf32 precisions for better fitting as well as faster training.
